...
exports.CreateArticleRequestStruct = void 0;
const superstruct_1 = require("superstruct");
exports.CreateArticleRequestStruct = (0, superstruct_1.object)({
    /**
     * [데이터 전처리 - 데이터 변환]
     *
     ...
     */
    title: (0, superstruct_1.coerce)((0, superstruct_1.nonempty)((0, superstruct_1.string)()), (0, superstruct_1.string)(), (value) => value.trim()), // 또는 trimmed() 를 사용하여 구현할 수 있습니다.
