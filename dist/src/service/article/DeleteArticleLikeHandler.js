...
exports.DeleteArticleLikeHandler = void 0;
// Prisma 로드
...
class DeleteArticleLikeHandler {
    static handle(requester_1, _a) {
        return __awaiter(this, arguments, void 0, function* (requester, { articleId }) {
            ...
            if (!articleEntity) {
                throw new NotFoundException_1.NotFoundException('글을 찾을 수 없습니다.', ExceptionMessage_1.ExceptionMessage.ARTICLE_NOT_FOUND);
            }
...
exports.DeleteArticleLikeHandler = DeleteArticleLikeHandler;
