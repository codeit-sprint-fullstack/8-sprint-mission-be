...
exports.GetUserProductListHandler = void 0;
// Prisma 로드
...
class GetUserProductListHandler {
    static handle(requester_1, _a) {
        return __awaiter(this, arguments, void 0, function* (requester, { page, pageSize, keyword }) {
            ...
            const productCount = yield prismaClient_1.prismaClient.product.count({
                where: {
            ...
            if (!productEntities) {
                throw new NotFoundException_1.NotFoundException('Products not found', ExceptionMessage_1.ExceptionMessage.PRODUCT_NOT_FOUND);
            }
            const products = productEntities.map((productEntity) => new Product_1.ProductDomain(productEntity));
            return {
...
exports.GetUserProductListHandler = GetUserProductListHandler;
