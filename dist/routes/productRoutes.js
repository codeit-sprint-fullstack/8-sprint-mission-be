 ...
 */
router.patch("/:id", authMiddleware, checkOwnership("product"), asyncHandler(updateProduct));
/**
 * @swagger
 * /products/{id}:
 *   delete:
 ...
 *         description: 존재하지 않는 상품
 */
router.delete("/:id", authMiddleware, checkOwnership("product"), asyncHandler(deleteProduct));
/**
 * @swagger
...
router.post("/:productId/comments", authMiddleware, asyncHandler(createComment));
