 ...
 */
router.patch("/:id", authMiddleware, checkOwnership("article"), asyncHandler(updateArticle));
/**
 * @swagger
 * /articles/{id}:
 *   delete:
 ...
 *         description: 존재하지 않는 게시글
 */
router.delete("/:id", authMiddleware, checkOwnership("article"), asyncHandler(deleteArticle));
/**
 * @swagger
 * /articles/{id}/like:
 *   post:
...
router.post("/:articleId/comments", authMiddleware, asyncHandler(createComment));
