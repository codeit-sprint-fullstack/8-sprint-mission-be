 ...
 *         description: 존재하지 않는 댓글
 */
router.patch("/:id", authMiddleware, checkOwnership("comment"), asyncHandler(updateComment));
router.delete("/:id", authMiddleware, checkOwnership("comment"), asyncHandler(deleteComment));
